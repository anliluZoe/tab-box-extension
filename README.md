...
4. **访问统计与清理**：可按近 1 / 2 / 3 天未访问筛选闲置标签页并一键关闭；也可按「访问最少 / 最久未用」排序。
5. **右键快捷入口**：在网页上右键可看到「标签盒」子菜单，直接分组、关重复、关同域名标签页等。
6. **检查更新**：弹窗里可一键对比 GitHub 最新 Release；有新版本会打开下载页。

## 安装

推荐从 Release 下载 zip 后解压安装：https://github.com/anliluZoe/brower-extension/releases

解压后会得到 `tab-box` 文件夹，加载扩展时选择这个文件夹即可。
